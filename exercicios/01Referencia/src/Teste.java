...
public class Teste {
	...
	public static void main(String[] args) {
		...
		//c.setTelefone(JOptionPane.showInputDialog("Fone"));
		...
		c.setEndereco(e);
		// final do objeto endereço
		
		JOptionPane.showMessageDialog(null, c.getNome(), "Aviso", JOptionPane.INFORMATION_MESSAGE);
		JOptionPane.showMessageDialog(null, c.getEmail(), "Aviso", JOptionPane.INFORMATION_MESSAGE);
		JOptionPane.showMessageDialog(null, c.getTelefone().getNumero(), "Aviso", JOptionPane.INFORMATION_MESSAGE);
